...
validateForms('.callback-form',
 ...
 { name: {required: 'Вы должны ввести имя'}, phone: {required: 'Введите номер телефона'}},
  '.thanks-popup');


  validateForms('.cart-modal__form',
  { name: {required: true}, phone: {required: true} , email: {required: true, email: true} },
 { name: {required: 'Вы должны ввести имя'}, phone: {required: 'Введите номер телефона'}, email: {required: 'Вы должны ввести email', email: 'Вы должны ввести корректный email'}},
  '.thanks-popup');